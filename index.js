...
{ topic: 'Bonding', q: 'Which molecule is paramagnetic?', choices: ['N₂', 'O₂', 'CO', 'F₂'], answer: 1, explanation: 'O₂ has two unpaired electrons in antibonding π* orbitals according to MO theory.' },
{ topic: 'Bonding', q: 'Which resonance structure contributes most to the resonance hybrid?', choices: ['The one with the most formal charges', 'The one with complete octets and minimal formal charges', 'The one with the fewest bonds', 'All contribute equally'], answer: 1, explanation: 'The best resonance contributor minimizes formal charges while satisfying octets.' },
{ topic: 'Bonding', q: 'Which hybrid orbital has the greatest percent s-character?', choices: ['sp', 'sp²', 'sp³', 'sp³d'], answer: 0, explanation: 'sp orbitals are 50% s-character, higher than sp² (33%) and sp³ (25%).' },
{ topic: 'Bonding', q: 'Which C-H bond is the strongest?', choices: ['sp³ C-H', 'sp² C-H', 'sp C-H', 'They are all equal'], answer: 2, explanation: 'Greater s-character produces shorter, stronger bonds.' },
{ topic: 'Bonding', q: 'Which species has the highest average N-O bond order?', choices: ['NO₂⁻', 'NO₃⁻', 'NO₂⁺', 'NO'], answer: 2, explanation: 'NO₂⁺ contains two N=O double bonds, so each bond has bond order 2.' },
{ topic: 'Bonding', q: 'Which molecule exhibits resonance?', choices: ['CH₄', 'NH₃', 'CO₃²⁻', 'H₂'], answer: 2, explanation: 'Carbonate has three equivalent resonance structures.' },
{ topic: 'Bonding', q: 'In benzene, every carbon-carbon bond has an average bond order of', choices: ['1', '1.33', '1.5', '2'], answer: 2, explanation: 'Delocalized π electrons make every C-C bond equivalent with bond order 1.5.' },
{ topic: 'Bonding', q: 'Which species has the greatest bond order?', choices: ['N₂', 'N₂⁺', 'N₂⁻', 'O₂'], answer: 0, explanation: 'N₂ has a bond order of 3, greater than the others.' },
{ topic: 'Bonding', q: 'Removing one electron from O₂ produces', choices: ['A weaker bond', 'A stronger bond', 'No change in bond strength', 'An ionic bond'], answer: 1, explanation: 'Removing an antibonding electron increases bond order from 2 to 2.5.' },
{ topic: 'Bonding', q: 'Adding one electron to O₂ results in', choices: ['A longer bond', 'A shorter bond', 'No change in bond length', 'A triple bond'], answer: 0, explanation: 'Adding an electron to an antibonding orbital decreases bond order.' },
{ topic: 'Bonding', q: 'Which atom can never expand its octet?', choices: ['Sulfur', 'Phosphorus', 'Nitrogen', 'Xenon'], answer: 2, explanation: 'Second-period elements like nitrogen cannot exceed eight valence electrons.' },
{ topic: 'Bonding', q: 'Which compound is electron-deficient?', choices: ['CO₂', 'BF₃', 'NH₃', 'CH₄'], answer: 1, explanation: 'Boron has only six electrons surrounding it in BF₃.' },
{ topic: 'Bonding', q: 'Which molecule contains a coordinate covalent bond?', choices: ['NH₄⁺', 'Cl₂', 'CO₂', 'H₂'], answer: 0, explanation: 'NH₃ donates a lone pair to H⁺ to form NH₄⁺.' },
{ topic: 'Bonding', q: 'Which bond is most ionic?', choices: ['Na-Cl', 'H-Cl', 'C-H', 'Cl-Cl'], answer: 0, explanation: 'The largest electronegativity difference produces the greatest ionic character.' },
{ topic: 'Bonding', q: 'Which bond has the greatest polarity?', choices: ['C-F', 'O-H', 'N-H', 'C-H'], answer: 0, explanation: 'The C-F bond has the largest electronegativity difference among these choices.' },
{ topic: 'Bonding', q: 'Which molecule has the largest molecular dipole moment?', choices: ['CO₂', 'CH₄', 'NH₃', 'BF₃'], answer: 2, explanation: 'NH₃ is trigonal pyramidal, so its bond dipoles do not cancel.' },
{ topic: 'Bonding', q: 'Which intermolecular force is strongest?', choices: ['London dispersion', 'Dipole-dipole', 'Hydrogen bonding', 'Ion-induced dipole'], answer: 2, explanation: 'Hydrogen bonding is the strongest common intermolecular force between neutral molecules.' },
{ topic: 'Bonding', q: 'Which compound can form hydrogen bonds with itself?', choices: ['CH₄', 'HCl', 'NH₃', 'CO₂'], answer: 2, explanation: 'NH₃ contains N-H bonds and a lone pair on nitrogen.' },
{ topic: 'Bonding', q: 'Which substance has the highest boiling point?', choices: ['HF', 'HCl', 'HBr', 'HI'], answer: 0, explanation: 'HF forms strong hydrogen bonds, greatly increasing its boiling point.' },
{ topic: 'Bonding', q: 'As molecular size increases among nonpolar molecules, London dispersion forces generally', choices: ['Decrease', 'Remain constant', 'Increase', 'Disappear'], answer: 2, explanation: 'Larger electron clouds are more polarizable, strengthening dispersion forces.' },
{ topic: 'Bonding', q: 'Which solid is classified as a network covalent solid?', choices: ['NaCl', 'Diamond', 'Copper', 'Dry ice'], answer: 1, explanation: 'Diamond consists of a continuous network of covalent bonds throughout the crystal.' },
{ topic: 'Bonding', q: 'Which substance conducts electricity in the solid state?', choices: ['NaCl', 'Diamond', 'Copper', 'Ice'], answer: 2, explanation: 'Copper conducts because of its mobile, delocalized electrons.' },
{ topic: 'Bonding', q: 'Which substance becomes electrically conductive only after melting?', choices: ['Copper', 'Diamond', 'NaCl', 'Quartz'], answer: 2, explanation: 'Molten NaCl contains free-moving ions that conduct electricity.' },
{ topic: 'Bonding', q: 'Which substance has the highest melting point?', choices: ['I₂', 'NaCl', 'Diamond', 'CO₂'], answer: 2, explanation: 'Diamond has an extensive network of strong covalent bonds.' },
{ topic: 'Bonding', q: 'Graphite conducts electricity because it contains', choices: ['Mobile ions', 'Delocalized electrons', 'Hydrogen bonds', 'Metal ions'], answer: 1, explanation: 'Each carbon contributes a delocalized electron that can move through the layers.' },
{ topic: 'Bonding', q: 'Which property is characteristic of metallic bonding?', choices: ['Brittleness', 'Electrical insulation', 'Malleability', 'Low melting point'], answer: 2, explanation: 'Metallic bonds allow atoms to slide past one another without breaking the bond.' },
{ topic: 'Bonding', q: 'Which compound has the greatest lattice energy?', choices: ['NaF', 'NaCl', 'KCl', 'KI'], answer: 0, explanation: 'NaF contains the smallest ions, resulting in the strongest electrostatic attraction.' },
{ topic: 'Bonding', q: 'Which ionic compound has the highest lattice energy?', choices: ['NaCl', 'MgO', 'KBr', 'LiF'], answer: 1, explanation: 'MgO contains ions with ±2 charges, producing much stronger attractions.' },
{ topic: 'Bonding', q: 'As bond order increases, bond energy generally', choices: ['Decreases', 'Remains constant', 'Increases', 'Becomes zero'], answer: 2, explanation: 'Higher bond order corresponds to stronger, more energetic bonds.' },
{ topic: 'Bonding', q: 'As bond order increases, bond length generally', choices: ['Increases', 'Decreases', 'Stays the same', 'Becomes unpredictable'], answer: 1, explanation: 'Higher bond order pulls atoms closer together.' },
{ topic: 'Bonding', q: 'Which bond requires the most energy to break?', choices: ['O-O', 'O=O', 'N≡N', 'Cl-Cl'], answer: 2, explanation: 'The nitrogen triple bond is among the strongest chemical bonds.' },
{ topic: 'Bonding', q: 'Which species contains exactly one unpaired electron?', choices: ['O₂⁺', 'N₂', 'Ne₂', 'CO'], answer: 0, explanation: 'Removing one electron from O₂ leaves one unpaired electron.' },
{ topic: 'Bonding', q: 'Which molecule is diamagnetic?', choices: ['O₂', 'NO', 'N₂', 'O₂⁻'], answer: 2, explanation: 'All electrons in N₂ are paired.' },
{ topic: 'Bonding', q: 'Which molecule has the greatest average C-O bond length?', choices: ['CO', 'CO₂', 'CO₃²⁻', 'CH₃OH'], answer: 2, explanation: 'Resonance in carbonate gives each C-O bond an average bond order of 1.33, making them longer than double bonds.' },
{ topic: 'Bonding', q: 'Which atom in NO₃⁻ has a positive formal charge?', choices: ['Nitrogen', 'All oxygens', 'One oxygen', 'None'], answer: 0, explanation: 'Nitrogen has a formal charge of +1 in each resonance structure.' },
{ topic: 'Bonding', q: 'The formal charges of all atoms in CH₄ are', choices: ['+1', '−1', '0', 'Mixed'], answer: 2, explanation: 'Methane has no formal charges on any atom.' },
{ topic: 'Bonding', q: 'Which species violates the octet rule by having fewer than eight electrons around the central atom?', choices: ['NH₄⁺', 'BF₃', 'SF₆', 'CO₂'], answer: 1, explanation: 'Boron has only six valence electrons in BF₃.' },
{ topic: 'Bonding', q: 'Which species violates the octet rule by having more than eight electrons around the central atom?', choices: ['PCl₅', 'CO₂', 'NH₃', 'BF₃'], answer: 0, explanation: 'Phosphorus expands its octet to accommodate five bonds.' },
{ topic: 'Bonding', q: 'Which molecule has the greatest number of sigma bonds?', choices: ['C₂H₂', 'C₂H₄', 'C₂H₆', 'CO₂'], answer: 2, explanation: 'Ethane contains seven sigma bonds: one C-C and six C-H.' },
{ topic: 'Bonding', q: 'How many pi bonds are present in carbon dioxide?', choices: ['0', '1', '2', '4'], answer: 2, explanation: 'Each C=O double bond contributes one pi bond.' },
...
{ topic: 'Organic Chemistry', q: 'Which functional group contains a carbonyl carbon bonded to two carbon atoms?', choices: ['Aldehyde', 'Ketone', 'Ester', 'Amide'], answer: 1, explanation: 'A ketone contains a carbonyl group bonded to two carbon atoms.' },
{ topic: 'Organic Chemistry', q: 'Which reagent converts an alkene into an alcohol following Markovnikov addition?', choices: ['H₂/Pd', 'H₂O, H₂SO₄', 'Br₂', 'O₃'], answer: 1, explanation: 'Acid-catalyzed hydration adds water across the double bond following Markovnikov’s rule.' },
{ topic: 'Organic Chemistry', q: 'Which reagent converts an alkene into an alcohol with anti-Markovnikov regiochemistry?', choices: ['H₂SO₄/H₂O', 'Hg(OAc)₂, NaBH₄', 'BH₃·THF then H₂O₂/OH⁻', 'HBr'], answer: 2, explanation: 'Hydroboration-oxidation gives anti-Markovnikov alcohols with syn addition.' },
{ topic: 'Organic Chemistry', q: 'Which functional group is present in CH₃COOCH₃?', choices: ['Ether', 'Ester', 'Ketone', 'Alcohol'], answer: 1, explanation: 'CH₃COOCH₃ is an ester containing the -COO- linkage.' },
{ topic: 'Organic Chemistry', q: 'Which compound is an aldehyde?', choices: ['CH₃CHO', 'CH₃COCH₃', 'CH₃COOH', 'CH₃OH'], answer: 0, explanation: 'CH₃CHO (ethanal) contains a terminal carbonyl group.' },
{ topic: 'Organic Chemistry', q: 'What is the IUPAC name of CH₃CH₂OH?', choices: ['Methanol', 'Ethanol', 'Propanol', 'Ethanal'], answer: 1, explanation: 'The molecule contains two carbons and a hydroxyl group, making it ethanol.' },
{ topic: 'Organic Chemistry', q: 'What is the IUPAC name of CH₃COCH₃?', choices: ['Propanal', 'Propanone', 'Propanol', 'Propanoic acid'], answer: 1, explanation: 'CH₃COCH₃ is the three-carbon ketone propanone.' },
{ topic: 'Organic Chemistry', q: 'Which compound is aromatic?', choices: ['Cyclohexane', 'Benzene', 'Cyclohexene', 'Cyclobutane'], answer: 1, explanation: 'Benzene has a conjugated ring with 6 π electrons, satisfying Hückel’s rule.' },
{ topic: 'Organic Chemistry', q: 'Which reagent is commonly used to hydrogenate an alkene?', choices: ['Br₂', 'H₂/Pd', 'KMnO₄', 'HCl'], answer: 1, explanation: 'Hydrogen gas with a palladium catalyst reduces alkenes to alkanes.' },
{ topic: 'Organic Chemistry', q: 'Which functional group gives compounds their acidic properties?', choices: ['Alcohol', 'Carboxylic acid', 'Ether', 'Alkene'], answer: 1, explanation: 'The carboxyl (-COOH) group readily donates a proton.' },
{ topic: 'Organic Chemistry', q: 'Which alcohol is classified as tertiary?', choices: ['CH₃OH', 'CH₃CH₂OH', '(CH₃)₃COH', 'CH₃CH(OH)CH₃'], answer: 2, explanation: 'The OH-bearing carbon is attached to three other carbons.' },
{ topic: 'Organic Chemistry', q: 'Which product forms when ethanol is completely oxidized?', choices: ['Ethanal', 'Ethene', 'Ethanoic acid', 'Methanol'], answer: 2, explanation: 'Primary alcohols oxidize first to aldehydes, then to carboxylic acids.' },
{ topic: 'Organic Chemistry', q: 'Which reagent distinguishes alkenes from alkanes?', choices: ['NaOH', 'Br₂', 'NaCl', 'H₂SO₄'], answer: 1, explanation: 'Bromine solution is rapidly decolorized by alkenes through addition.' },
{ topic: 'Organic Chemistry', q: 'Which functional group is present in proteins?', choices: ['Ester', 'Amide', 'Ether', 'Ketone'], answer: 1, explanation: 'Peptide bonds are amide linkages.' },
{ topic: 'Organic Chemistry', q: 'Which molecule has the highest boiling point?', choices: ['Propane', 'Propanol', 'Propene', 'Propanal'], answer: 1, explanation: 'Alcohols exhibit hydrogen bonding, raising their boiling points.' },
{ topic: 'Organic Chemistry', q: 'Which compound can exist as cis-trans isomers?', choices: ['Ethane', 'Ethene', '2-Butene', 'Methane'], answer: 2, explanation: '2-Butene has two different groups attached to each alkene carbon.' },
{ topic: 'Organic Chemistry', q: 'Which functional group is found in acetone?', choices: ['Alcohol', 'Ketone', 'Aldehyde', 'Carboxylic acid'], answer: 1, explanation: 'Acetone (propanone) is the simplest ketone.' },
{ topic: 'Organic Chemistry', q: 'What is the major product of complete combustion of a hydrocarbon?', choices: ['CO and H₂', 'CO₂ and H₂O', 'C and H₂O', 'CH₄ and O₂'], answer: 1, explanation: 'Complete combustion produces carbon dioxide and water.' },
{ topic: 'Organic Chemistry', q: 'Which reagent cleaves an alkene into carbonyl compounds?', choices: ['Br₂', 'O₃', 'H₂', 'NaOH'], answer: 1, explanation: 'Ozonolysis breaks carbon-carbon double bonds to form aldehydes and ketones.' },
{ topic: 'Organic Chemistry', q: 'Which hydrocarbon contains only single carbon-carbon bonds?', choices: ['Alkene', 'Alkyne', 'Alkane', 'Arene'], answer: 2, explanation: 'Alkanes are saturated hydrocarbons containing only single bonds.' },
{ topic: 'Organic Chemistry', q: 'How many chiral centers are present in 2-butanol?', choices: ['0', '1', '2', '3'], answer: 1, explanation: 'The carbon bearing the OH group is attached to four different groups, making it the only chiral center.' },
{ topic: 'Organic Chemistry', q: 'Which compound is chiral?', choices: ['2-butanol', '2-propanol', 'Methanol', 'tert-Butanol'], answer: 0, explanation: '2-Butanol contains one carbon attached to four different substituents.' },
{ topic: 'Organic Chemistry', q: 'Enantiomers differ in their', choices: ['Molecular formula', 'Connectivity', 'Three-dimensional arrangement', 'Functional group'], answer: 2, explanation: 'Enantiomers have identical connectivity but differ as non-superimposable mirror images.' },
{ topic: 'Organic Chemistry', q: 'Which compound has the highest boiling point?', choices: ['Hexane', '1-Hexanol', 'Hexene', 'Hexyne'], answer: 1, explanation: 'Alcohols form hydrogen bonds, giving them much higher boiling points.' },
{ topic: 'Organic Chemistry', q: 'Which functional group gives the strongest IR absorption near 1700 cm⁻¹?', choices: ['Alkene', 'Carbonyl', 'Alcohol', 'Amine'], answer: 1, explanation: 'The C=O stretching vibration produces a strong absorption near 1700 cm⁻¹.' },
{ topic: 'Organic Chemistry', q: 'Which functional group produces a broad IR peak around 3200–3600 cm⁻¹?', choices: ['Alkene', 'Carbonyl', 'Alcohol', 'Alkane'], answer: 2, explanation: 'The O-H bond gives a broad absorption due to hydrogen bonding.' },
{ topic: 'Organic Chemistry', q: 'In a ¹H NMR spectrum, which proton usually appears farthest downfield?', choices: ['Alkane proton', 'Alkyne proton', 'Aldehyde proton', 'Allylic proton'], answer: 2, explanation: 'Aldehyde protons typically resonate around 9–10 ppm.' },
{ topic: 'Organic Chemistry', q: 'How many unique carbon signals appear in the ¹³C NMR spectrum of propane?', choices: ['1', '2', '3', '4'], answer: 1, explanation: 'The two terminal carbons are equivalent, giving two unique carbon environments.' },
{ topic: 'Organic Chemistry', q: 'Which reaction proceeds through a carbocation intermediate?', choices: ['SN2', 'SN1', 'Hydrogenation', 'Ozonolysis'], answer: 1, explanation: 'SN1 reactions involve formation of a carbocation before nucleophilic attack.' },
{ topic: 'Organic Chemistry', q: 'Which reaction occurs in a single concerted step?', choices: ['SN1', 'SN2', 'E1', 'Free radical substitution'], answer: 1, explanation: 'SN2 reactions occur in one step with simultaneous bond breaking and bond forming.' },
{ topic: 'Organic Chemistry', q: 'Which substrate reacts fastest by the SN2 mechanism?', choices: ['Tertiary alkyl bromide', 'Secondary alkyl bromide', 'Primary alkyl bromide', 'Tertiary alkyl chloride'], answer: 2, explanation: 'Primary substrates experience the least steric hindrance.' },
{ topic: 'Organic Chemistry', q: 'Which substrate reacts fastest by the SN1 mechanism?', choices: ['Methyl chloride', 'Primary bromide', 'Secondary bromide', 'Tertiary bromide'], answer: 3, explanation: 'SN1 reactions are fastest for substrates that form the most stable carbocations.' },
{ topic: 'Organic Chemistry', q: 'Which is the best leaving group?', choices: ['OH⁻', 'F⁻', 'Br⁻', 'NH₂⁻'], answer: 2, explanation: 'Bromide is much more stable after leaving than the other choices.' },
{ topic: 'Organic Chemistry', q: 'Which solvent favors SN1 reactions?', choices: ['Hexane', 'Acetone', 'Water', 'Diethyl ether'], answer: 2, explanation: 'Polar protic solvents stabilize carbocations and leaving groups.' },
{ topic: 'Organic Chemistry', q: 'Which solvent favors SN2 reactions?', choices: ['Water', 'Methanol', 'DMSO', 'Ethanol'], answer: 2, explanation: 'Polar aprotic solvents enhance nucleophilicity and favor SN2 reactions.' },
{ topic: 'Organic Chemistry', q: 'Which reagent is a strong nucleophile but weak base?', choices: ['OH⁻', 'NH₂⁻', 'I⁻', 'tert-Butoxide'], answer: 2, explanation: 'Iodide is highly nucleophilic but relatively weakly basic.' },
{ topic: 'Organic Chemistry', q: 'Which reagent is most likely to promote an E2 elimination?', choices: ['H₂O', 'I⁻', 'tert-Butoxide', 'NH₃'], answer: 2, explanation: 'Bulky strong bases favor elimination over substitution.' },
{ topic: 'Organic Chemistry', q: 'According to Zaitsev’s rule, the major elimination product is usually the', choices: ['Least substituted alkene', 'Most substituted alkene', 'Cycloalkane', 'Alkyne'], answer: 1, explanation: 'More substituted alkenes are generally more stable.' },
{ topic: 'Organic Chemistry', q: 'Which alkene is more stable?', choices: ['1-Butene', '2-Butene', 'Ethene', 'Propene'], answer: 1, explanation: 'Internal alkenes are generally more stable than terminal alkenes.' },
{ topic: 'Organic Chemistry', q: 'Which is more stable?', choices: ['cis-2-Butene', 'trans-2-Butene', 'Both equally stable', 'Cannot be determined'], answer: 1, explanation: 'The trans isomer has less steric repulsion between substituents.' }
];
